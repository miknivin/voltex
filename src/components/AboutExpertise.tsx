    ...
    <section className="relative overflow-hidden py-14 lg:py-20">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[2fr_3fr] lg:gap-16">
          ...
          <div>
            <h2 className="font-display text-2xl leading-tight font-medium tracking-tight text-text-primary sm:text-3xl">
              Expertise Before Estimation
            </h2>
            <p className="mt-4 text-base leading-[26px] text-text-muted">
